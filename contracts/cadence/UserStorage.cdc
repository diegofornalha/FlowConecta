// ProfileStorage.cdc
access(all) contract ProfileStorage {
    ...
    access(all) fun setProfile(userAddress: Address, name: String, tags: String, verified: Bool) {
        self.profiles[userAddress] = Profile(name: name, tags: tags, followers: 0, verified: verified, reputation: 0)
    }
